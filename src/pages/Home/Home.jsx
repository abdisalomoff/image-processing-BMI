...
const Home = () => {
    ...
    return (
        <section className="home" id="wrapper">
            <h1 className="home__title">Tasvirni qayta ishlash</h1>
            <div className="home__head">
                <p>Tasvirni browser orqali oson tahrirlang.</p>
            </div>
            ...
            <div className="home__actions">
                <div className="home__load-buttons">
                    <TheButton onClick={handleButtonClick} title="Tasvirni yuklash" normal={true} adjacent="left">Tasvirni yuklash</TheButton>
                ...
                <TheButton onClick={openModal} title="Просмотр информации о разработчике">Muallif haqida ma'lumot</TheButton>
            </div>
            {linkOpen && 
                <div className="home__actions">
                    <Input 
                    ...
                    placeholder="Rasmning URL manzilini kiriting"
                    />
                    <TheButton onClick={handleImageChange} title="Rasm yuklash" normal>Rasm yuklash</TheButton>
                </div>
            }
            {image &&
            ...
            <Modal className="about" isOpen={isModalOpen} onClose={closeModal} title="Muallif haqida">
                <p className="about__text">Abdisalomov Abdisalomov tomonidan, Toshkent axborot texnologiyalari universiteti, Bitiruv malakaviy ishi, 2024 y.</p>
                <div className="about__field">
                    <a className="about__link" href="https://github.com/abdisalomoff/image-processing-BMI">GitHub</a>
                </div>
            </Modal>
        </section>
    )
